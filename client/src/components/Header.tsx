...
export default function Header() {
	...
	const { toggleTheme } = useZTThemeStore();
	...
	return (
		<header className='w-full mb-4 border-b shadow-xs border-gray-300 bg-white'>
						...
						{currentUser ? (
							<>
								...
								>
									...
									<DropdownItem href={`/user/${currentUser.id}`}>
										Profile
									</DropdownItem>
									<DropdownItem href={'/new-post'}>Create Post</DropdownItem>
									<DropdownItem href={'/reading-list'}>
										My Reading List
									</DropdownItem>
